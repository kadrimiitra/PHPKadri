...
<html lang="en">
    ...
    <body>
        ...
        function tervita($kylaline = "Kati"){
        echo "Tere $kylaline"; 
        }
       ...
       tervita ("Kai");
        uudiskiri();
       function headMotted(){
        $alus= array("Mari", "Kati", "Miia");
        $oeldis = array("kuulab", "teeb", "istub");
       ...
       ?>
        ...
        <h1>Massiivid</h1>
       <?php
       $nimed = array("Mari", "Kati", "Juuli", "Mart", "Ants", "Kai", "Peeter", "Ivo");
       sort($nimed);   
       //var_dump($nimed);
        ...
        echo "-----------------------<br>";
        echo "Viimane nimi: ".$nimed[array_rand($nimed)]. "<br>";
        ?>
...
$keskmine_palk_kahel_komakohal = number_format($keskmine_palk, 2);
echo "Keskmine palk: $keskmine_palk_kahel_komakohal";
?>
